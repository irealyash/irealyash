...
<a href="https://ysharma.me" target="_blank" rel="noopener noreferrer">Portfolio</a> | <a href="https://linkedin.com/in/yash-sharma-code" target="_blank" rel="noopener noreferrer">LinkedIn</a> | <a href="mailto:yash5112007@gmail.com" target="_blank" rel="noopener noreferrer">Email</a>
...
*   **<a href="https://github.com/irealyash/autonomous-browser-agent" target="_blank" rel="noopener noreferrer">Autonomous Browser Agent</a>**: A Chrome extension that turns your browser into an AI-powered automation assistant using the Gemini API to navigate and execute complex tasks[cite: 1].
*   **<a href="https://github.com/irealyash/unipulse-campus-network" target="_blank" rel="noopener noreferrer">UniPulse</a>**: A campus community platform built to consolidate university events and provide anonymous course-section chats[cite: 1].
